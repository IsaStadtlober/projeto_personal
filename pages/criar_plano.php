...
<body class="d-flex flex-column min-vh-100">
    ...
    <main id="mainCriar" class="d-flex justify-content-center align-items-center min-vh-100 w-100 position-relative" style="margin-top: 70px;">
        ...
        <div id="cardInicial" class="card shadow-lg rounded-4 border-0" style="width: 620px; max-width: 95vw; min-height: 450px;">
        ...
        <!-- Card Semanal -->
        <div id="cardSemanal" class="card shadow-lg rounded-4 border-0 d-none" style="width: 620px; max-width: 95vw; min-height: 450px;">
            <div class="card-body p-5">
        ...
        <!-- Card Mensal -->
        <div id="cardMensal" class="card shadow-lg rounded-4 border-0 d-none" style="width: 620px; max-width: 95vw; min-height: 450px;">
            <div class="card-body p-5">
        ...
        <!-- Card Anual -->
        <div id="cardAnual" class="card shadow-lg rounded-4 border-0 d-none" style="width: 620px; max-width: 95vw; min-height: 450px;">
            <div class="card-body p-5">
