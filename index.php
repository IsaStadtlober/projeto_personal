        ...
        <div class="row g-3">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="card h-100 shadow atividade-card rounded-1 border-1 border-secondary">
              ...
              <img src="imagens/img_academia1.png" alt="Academia" class="img-fluid mx-auto d-block mb-5 pb-3" style="width: 65%; object-fit: cover;">
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="card h-100 shadow atividade-card rounded-1 border-1 border-secondary">
              ...
              <img src="imagens/img_luta2.png" alt="Lutas" class="img-fluid mx-auto d-block mb-5 pb-3" style="width: 65%; object-fit: cover;">
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="card h-100 shadow atividade-card rounded-1 border-1 border-secondary">
              ...
              <img src="imagens/img_skate3.png" alt="Skate" class="img-fluid mx-auto d-block mb-5 pb-3" style="width: 65%; object-fit: cover;">
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="card h-100 shadow atividade-card bg-dark text-white rounded-1">
              <div class="card-body">
                ...
                <a href="#" class="btn btn-outline-light rounded-0 mt-2">QUERO CONHECER. . .</a>
              </div> 
            </div>
          </div>
